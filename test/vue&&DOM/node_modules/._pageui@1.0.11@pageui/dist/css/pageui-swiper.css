...
.photo-browser .tab-item.photo-browser-prev {
  left: 0;
}
.photo-browser .tab-item.photo-browser-next {
  right: 0;
}
.photo-browser .photo-pagination-box {
  position: absolute;
  width: 100%;
  bottom: 1.5rem;
  left: 0;
...
.photo-browser .photo-pagination-box .photo-browser-pagination {
  width: 8px;
  height: 8px;
...
.photo-browser .photo-pagination-box .photo-browser-pagination.active {
  background: #fff;
}
