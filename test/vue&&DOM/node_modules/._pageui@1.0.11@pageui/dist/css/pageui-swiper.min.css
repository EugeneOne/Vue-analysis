...
.photo-browser .tab-item{position:absolute;top:50%;z-index:1000;margin-top:-32px;padding:20px}
.photo-browser .tab-item.photo-browser-prev{left:0}
.photo-browser .tab-item.photo-browser-next{right:0}
.photo-browser .photo-pagination-box{position:absolute;width:100%;bottom:1.5rem;left:0;text-align:center;-webkit-transition:.3s;-o-transition:.3s;transition:.3s;-webkit-transform:translate3d(0,0,0);-ms-transform:translate3d(0,0,0);-o-transform:translate3d(0,0,0);transform:translate3d(0,0,0);z-index:10}
.photo-browser .photo-pagination-box .photo-browser-pagination{width:8px;height:8px;display:inline-block;border-radius:100%;background:#454545;opacity:1;margin:0 5px}
.photo-browser .photo-pagination-box .photo-browser-pagination.active{background:#fff}
...
.page[data-page=photo-browser-slides] .toolbar a{color:#006CBA}
...
.photo-browser-swiper-container{position:absolute;left:0;top:0;width:100%;height:100%;overflow:hidden;background:#000;-webkit-transition:.4s;-o-transition:.4s;transition:.4s}
